...
function () {
  ...
  _createClass(ErrorBag, [{
    ...
    value: function getErrors(scope, field) {
      var errors = scope ? filter_1(this.errors, function (e) {
        return e.scope === scope;
      }) : this.errors;
      return field ? filter_1(errors, function (e) {
    ...
    value: function getMessages(scope) {
      ...
      if (scope) {
        errors = filter_1(errors, function (e) {
          return e.scope === scope;
        });
      }

      return map_1(errors, function (e) {
        return e.message;
      });
    }
  }, {
    ...
    value: function clear(scope) {
      var errors = Object.assign({}, this.errors);
      this.errors = scope ? filter_1(errors, function (e) {
        return e.scope !== scope;
      }) : [];
    }
  }, {
    ...
    value: function has(field, scope) {
      ...
      return findIndex_1(errors, function (e) {
        return e.field === field;
      }) !== -1;
    }
  }, {
    ...
    value: function replace(scope, error) {
      var errorFiltered = filter_1(this.errors, function (e) {
        return e.scope !== scope;
      });
      this.clear();
  ...
  _createClass(Validator, [{
    ...
    value: function discoveryScope(elm) {
      ...
      if (isScopeFound && !Object.keys(this.scopes).length) {
        ...
        forIn_1(this.form, function (form, name) {
          // discovery by query
          var _iteratorNormalCompletion = true;
          var _didIteratorError = false;
          var _iteratorError = undefined;
